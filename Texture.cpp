...
void Texture::Err(string errorString)
{
	cout << errorString << endl;
	SDL_Quit();
	exit(1);
}
void Texture::CheckShaderErrors(GLuint shader, string type)
{
	GLint success;
	GLchar infoLog[1024];
	if (type != "PROGRAM")
...
GLuint Texture::BuildShader(const char* vertexPath, const char* fragmentPath, const char* geometryPath)
{
...
void Texture::UseShader(GLuint program)
{
